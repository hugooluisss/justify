...
CREATE TABLE `usuario` (
  ...
  KEY `index_usuarioLocalidad` (`idLocalidad`),
  CONSTRAINT `fk_localidadUsuario` FOREIGN KEY (`idLocalidad`) REFERENCES `localidad` (`idLocalidad`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
INSERT INTO `usuario` VALUES (1,1,1,'hugooluisss@gmail.com','c474172120640848b304bcf01b0d55c4','2016-03-02 16:15:31','2016-03-06 18:46:05',NULL,'A','Hugo Luis Santiago Altamirano','H');
...
-- Dump completed on 2016-03-06 14:41:35
